...
public class AlertdialogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View customView = inflater.inflate(R.layout.fragment_alertdialog, container, false);
        status_textview_accept_check = (TextView) customView.findViewById(R.id.status_textview_accept_check);
        status_textview_availablenow = (TextView) customView.findViewById(R.id.status_textview_availablenow);
        status_textview_unaccept_check = (TextView) customView.findViewById(R.id.status_textview_unaccept_check);
