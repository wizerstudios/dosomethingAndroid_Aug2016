 ...
 */
public class Recreation_hobbies { String imag_inActive_recreation, imag_Active_recreation,image_name_recreation;
    int image_id_recreation;
    int category_id_recreation;
    boolean state;
