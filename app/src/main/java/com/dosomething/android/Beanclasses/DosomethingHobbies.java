...
public class DosomethingHobbies {

    String imag_inActive, imag_Active,image_name;
    int image_id,category_id;
    public DosomethingHobbies() {

    }

    public DosomethingHobbies(int image_id, int category_id, String image_name, String imag_Active, String imag_inActive) {
