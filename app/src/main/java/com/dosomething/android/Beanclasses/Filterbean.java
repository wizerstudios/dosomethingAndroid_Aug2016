...
public class Filterbean {
    ...
    String first_name, last_name, about, gender, age, date_of_birth, image2, image1, image3, online_status, Avilable_now, DoSomething, distance;
    ArrayList<HobbiesBean> hobbiesBeans = new ArrayList<>();
    String user_id;
    String imag_inActive, imag_Active, image_name;
    int image_id;
    String imag_inActive1, imag_Active1, image_name1;
    int image_id1;
    String imag_inActive2, imag_Active2, image_name2;
    int image_id2;
