...
public class Filterbean
{
    ...
    ArrayList<Dosomething_Bean> dosomething_beans;
    int
            image_id,
            image_id1,
            image_id2;

    public ArrayList<Dosomething_Bean> getDosomething_beans() {
        return dosomething_beans;
    }

    public void setDosomething_beans(ArrayList<Dosomething_Bean> dosomething_beans) {
