...
public class SplashActivity extends AppCompatActivity
    ...
    ViewPager
            mViewPager;
    Button
            activitymain_button_createaccount,
            activitymain_button_login;
    ...
    ImageView
            walkthrough_account_create_imageView;
    TextView
            walkthrough_account_create_TextView;
